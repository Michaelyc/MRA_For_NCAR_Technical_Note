...
void read_user_parameters()
{
	...
	if(CALCULATION_MODE == "optimization")
	{
		...
		{
			if(WORKER == 0) cout<<"Program exits with an error: the specified ALPHA_UPPER_BOUND "<<ALPHA_UPPER_BOUND<<" is smaller than the specified ALPHA_LOWER_BOUND "<<ALPHA_LOWER_BOUND<<".\n";
			MPI_Barrier(MPI_COMM_WORLD);
			MPI_Finalize();
			exit(EXIT_FAILURE);
		}
		...
		{
			if(WORKER == 0) cout<<"Program exits with an error: the specified TAU_UPPER_BOUND "<<TAU_UPPER_BOUND<<" is smaller than the specified TAU_LOWER_BOUND "<<TAU_LOWER_BOUND<<".\n";
			MPI_Barrier(MPI_COMM_WORLD);
			MPI_Finalize();
			exit(EXIT_FAILURE);
		}
		...
		{
			if(WORKER == 0) cout<<"Program exits with an error: the specified ALPHA_INITIAL_GUESS "<<ALPHA_INITIAL_GUESS<<" is smaller than the specified ALPHA_LOWER_BOUND "<<ALPHA_LOWER_BOUND<<".\n";
			MPI_Barrier(MPI_COMM_WORLD);
			MPI_Finalize();
			exit(EXIT_FAILURE);
		}
		...
		{
			if(WORKER == 0) cout<<"Program exits with an error: the specified TAU_INITIAL_GUESS "<<TAU_INITIAL_GUESS<<" is smaller than the specified TAU_LOWER_BOUND "<<TAU_LOWER_BOUND<<".\n";
			MPI_Barrier(MPI_COMM_WORLD);
			MPI_Finalize();
			exit(EXIT_FAILURE);
		}
		...
		{
			if(WORKER == 0) cout<<"Program exits with an error: the specified ALPHA_INITIAL_GUESS "<<ALPHA_INITIAL_GUESS<<" is smaller than the specified ALPHA_UPPER_BOUND "<<ALPHA_UPPER_BOUND<<".\n";
			MPI_Barrier(MPI_COMM_WORLD);
			MPI_Finalize();
			exit(EXIT_FAILURE);
		}
		...
		{
			if(WORKER == 0) cout<<"Program exits with an error: the specified TAU_INITIAL_GUESS "<<TAU_INITIAL_GUESS<<" is smaller than the specified TAU_UPPER_BOUND "<<TAU_UPPER_BOUND<<".\n";
			MPI_Barrier(MPI_COMM_WORLD);
			MPI_Finalize();
			exit(EXIT_FAILURE);
		}
