...
*/
{
    public:
        ...
        //observationResiduals: residuals after a linear regression to longitude, latitude, and a constant
        double *observationLon, *observationLat, *observationResiduals;
    ...
    private:
        ...
        //Eliminate duplicate observations and predictions
